...
<div class="wrap" style="visibility:hidden">
	...
	<div style="display:none;" id="new_form_content" class="main_form_container">
	  ...
	  <div>
			...
			<div class="simple_subscription_popup_checkbox"><label class="text simple_subscription_popup_tooltip" title="Disable the triggering event on links" style="width: 200px;"><input type="checkbox" name="openwithlink" class="inputtext openwithlink" value="0" /> Disable Open with Link</label></div>
