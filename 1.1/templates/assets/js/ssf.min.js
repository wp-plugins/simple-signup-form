...
(function(b){var d={init:function(a){function d(a){b("#mc_embed_signup").css({"-webkit-transition":"all "+a+"s ease-in","-moz-transition":"all "+a+"s ease-in","-o-transition":"all "+a+"s ease-in","-ms-transition":"all "+a+"s ease-in",transition:"all "+a+"s ease-in","-webkit-animation-duration":a+"s","-moz-animation-duration":a+"s","-ms-animation-duration":a+"s","-o-animation-duration":a+"s","animation-duration":a+"s"})}function s(){b("#mc_embed_signup").css("z-index","99999");1==a.lock&&b("#ssp_locker").css("display",
"block");"slide"==a.animation?"left"==k?b("#mc_embed_signup").css({left:f,top:g,opacity:"1"}):b("#mc_embed_signup").css({right:f,top:g,opacity:"1"}):(d(0),"left"==k?b("#mc_embed_signup").css({left:f,top:g,opacity:"0"}):b("#mc_embed_signup").css({right:f,top:g,opacity:"0"}),b("#mc_embed_signup").bind("animationend webkitAnimationEnd MSAnimationEnd oAnimationEnd",function(B){b("#mc_embed_signup").removeClass(a.animation).css({opacity:"1","z-index":"99999"})}),d(a.animtime),b("#mc_embed_signup").addClass(a.animation));
t=h=!0;1==a.once_per_user&&x("ssp","1",a.cookie_days,"days")}function u(){"slide"==a.animation?"left"==k?b("#mc_embed_signup").css({left:l,top:m,opacity:"0"}):b("#mc_embed_signup").css({right:l,top:m,opacity:"0"}):(b("#mc_embed_signup").bind("animationend webkitAnimationEnd MSAnimationEnd oAnimationEnd",function(B){b("#mc_embed_signup").removeClass(a.animation+"-out").css({opacity:"0","z-index":"-1"})}),b("#mc_embed_signup").addClass(a.animation+"-out"));1==a.lock&&b("#ssp_locker").css("display",
"none")}function C(a){return(new RegExp(/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i)).test(a)}
function x(a,b,r,c){if("days"==c){var e=new Date;e.setDate(e.getDate()+parseInt(r));e=escape(b)+(null==r?"":"; expires="+e.toUTCString());document.cookie=a+"="+e}"minutes"==c&&(c=new Date,e=c.getTime(),e+=parseInt(r),c.setTime(e),e=escape(b)+(null==r?"":"; expires="+c.toUTCString()),document.cookie=a+"="+e)}function v(a){var b=document.cookie,c=b.indexOf(" "+a+"=");-1==c&&(c=b.indexOf(a+"="));-1==c?b=null:(c=b.indexOf("=",c)+1,a=b.indexOf(";",c),-1==a&&(a=b.length),b=unescape(b.substring(c,a)));return b}
var n={animtime:.4,animation:"slide",autoopen:!0,mode:"mail",googleplus_clientid:"",googleplus_apikey:"",bgcolor:"#000",lockbgcolor:"#fff",buttonbgcolor:"#c7122f",buttoncolor:"#ffffff",closecolor:"#d71b1b",closefontsize:"18px",color:"#d71b1b",contentcolor:"#ccc",fontfamily:"Amaranth",contentfontfamily:"Amaranth",openwithlink:!0,contentfontsize:"13px",contentweight:"normal",title:"Subscribe to our Updates",text:"We will only send notification when we releasing FREE and Premium Plugins, Themes or Updates for any of our existing products.",
...
function(){"undefined"!=typeof gapi&&(gapi.client.setApiKey(a.googleplus_apikey),gapi.client.load("plus","v1",function(){}),gapi.signin.render("googleplusbtn",{clientid:a.googleplus_clientid,cookiepolicy:"single_host_origin",requestvisibleactions:"http://schema.org/AddAction",scope:"https://www.googleapis.com/auth/plus.login https://www.googleapis.com/auth/plus.profile.emails.read"}),document.getElementById("googleplusbtn").onclick=A)};window.handleAuthResult=function(a){document.getElementById("googleplusbtn");
a&&!a.error?D():A()}}""!=a.fontfamily&&"undefined"!=a.fontfamily&&(c=a.fontfamily+":400,700");""!=a.contentfontfamily&&"undefined"!=a.contentfontfamily&&(c=""!=c?c+("|"+a.contentfontfamily+":400,700"):a.contentfontfamily);""!=c&&(b("link[href='http://fonts.googleapis.com/css?family="+c+"']").length||b("head").append('<link rel="stylesheet" href="http://fonts.googleapis.com/css?family='+c+'" type="text/css" />'));b("link[href='http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css']").length||
...
"'"+a.fontfamily+"', serif");""!=a.contentfontfamily&&"undefined"!=a.contentfontfamily&&0!=b("#mc_embed_signup form").length&&b("#mc_embed_signup form p,#mc_embed_signup input").css("fontFamily","'"+a.contentfontfamily+"', serif");var l,m,f,g,k;"centercenter"==a.position&&(k="left",l=parseInt((b(window).width()-b("#mc_embed_signup").width())/2)+"px",f=parseInt((b(window).width()-b("#mc_embed_signup").width())/2)+"px",m="-100%",g=parseInt((b(window).height()-b("#mc_embed_signup").height())/2)+"px");
"slide"==a.animation&&("left"==k?b("#mc_embed_signup").css({left:l,top:m}):b("#mc_embed_signup").css({right:l,top:m}));d(a.animtime);b("#mc_embed_signup").css({"-webkit-transition":"all "+a.animtime+"s ease-in","-moz-transition":"all "+a.animtime+"s ease-in","-o-transition":"all "+a.animtime+"s ease-in","-ms-transition":"all "+a.animtime+"s ease-in",transition:"all "+a.animtime+"s ease-in","-webkit-animation-duration":a.animtime+"s","-moz-animation-duration":a.animtime+"s","-ms-animation-duration":a.animtime+
"s","-o-animation-duration":a.animtime+"s","animation-duration":a.animtime+"s"});800>b(window).width()&&(b("#mc_embed_signup").css({width:"100%"}),b(".signup input").css({width:"100%"}),f="0px",g=parseInt(b(window).height()-b("#mc_embed_signup").height())+"px");1==a.autoopen&&window.setTimeout(function(){(0==a.once_per_user||1==a.once_per_user&&"1"!=v("ssp"))&&(0==a.once_per_filled||1==a.once_per_filled&&"1"!=v("ssp_filled"))&&0==t&&s()},a.timer);1==a.openwithlink&&b(".openssform").click(function(){s()});
0!=a.openbottom&&b(window).scroll(function(){var c=b(document).scrollTop(),d=1==a.openbottom?10:parseInt(100-a.openbottom);b(window).scrollTop()+b(window).height()>b(document).height()-b(document).height()/100*d&&c>y&&0==h&&1!=t&&(0==a.once_per_user||1==a.once_per_user&&"1"!=v("ssp"))&&(h=!0,s());y=c});b("#ssp_email").focus();0==a.hideclose&&(1==a.closewithlayer?b("#mc_embed_close,#ssp_locker").click(function(){u();h=!1}):b("#mc_embed_close").click(function(){u();h=!1}));b("#subscribe").click(function(){if(0==
q)if(b("#subscribe").css({opacity:"0.2",cursor:"normal"}),q=1,C(b("#ssp_email").val())){var c={action:"ajax_ssp",sspcmd:"subscription_signup",email:b("#ssp_email").val(),mode:a.mode,double_optin:a.double_optin,update_existing:a.update_existing,replace_interests:a.replace_interests,mailchimp_listid:a.mailchimp_listid,send_welcome:a.send_welcome,signup_form_id:a.formid};b.post(a.path,c,function(c){if("success"==c)b(".signup").html(a.signup_success),window.setTimeout(function(){u();h=!1},2E3),q=0,b("#subscribe").css({opacity:"1",
cursor:"pointer"}),1==a.once_per_filled&&x("ssp_filled","1",a.filled_cookie_days,"days"),b("#ssp_social_login").remove();else{var d=b(".ssp_email").val();b(".ssp_email").css("color","#FC0303");b(".ssp_email").val("ERROR");setTimeout(function(){b(".ssp_email").css("color","");b(".ssp_email").val(d)},2E3);q=0;b("#subscribe").css({opacity:"1",cursor:"pointer"})}})}else{var d=b("#ssp_email").val();b("#ssp_email").css("color","#FC0303");b("#ssp_email").val(a.invalid_address);setTimeout(function(){b(".ssp_email").css("color",
"");b("#ssp_email").val(d);b("#subscribe").css({opacity:"1",cursor:"pointer"});q=0},2E3)}})},destroy:function(){b("#mc_embed_signup").remove();return 1}};b.fn.ssform=function(a){if(d[a])return d[a].apply(this,Array.prototype.slice.call(arguments,1));if("object"!==typeof a&&a)b.error("Method "+a+" does not exist on $.ssform");else return d.init.apply(this,arguments)}})(jQuery);